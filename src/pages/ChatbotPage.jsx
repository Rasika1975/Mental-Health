    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <button
                ...
                className="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-base font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105"
              >
              ...
              <button className="group inline-flex items-center justify-center px-8 py-4 border-2 border-gray-300 text-gray-700 text-base font-semibold rounded-xl hover:border-blue-600 hover:text-blue-600 bg-white transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 text-gray-500">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">University Approved</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8">
                ...
                <blockquote className="text-base text-gray-700 italic mb-6 leading-relaxed">
                  "{testimonial.text}"
                </blockquote>
                <div className="text-center">
      ...
      <div className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <button
            onClick={() => setShowIntro(false)}
            className="group inline-flex items-center justify-center px-10 py-5 bg-white text-blue-600 text-lg font-semibold rounded-xl hover:bg-gray-100 transition-all duration-300 shadow-2xl hover:shadow-3xl transform hover:scale-105"
          >
            <FiMessageCircle className="mr-3 text-xl" />
            Start Chatting Now
            <FiArrowRight className="ml-3 group-hover:translate-x-1 transition-transform" />
